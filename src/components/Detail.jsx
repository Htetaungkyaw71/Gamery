...
function Detail() {
  ...
  useEffect(()=>{
      if(details.length <= 0){
          ...
          let filterArr = details.filter(game=>game.id === +id)
  ...
  let screenshots = game && game.screenshots.map((item)=>{
    return(
        ...
        <div className='detail-page'>
          <div className='detail-row'>
              <div className='detail-col1'>
                ...
                <a href={game.game_url} className='play' target="_blank">
                  Play Now
                </a>
              </div>
              <div className='detail-col2'>
                  <h1>About {game.title}</h1>
                  <p>
                    {game.description}
                  </p>
              ...
              <div>
                 <h1>Minimum System Requirements ({game.platform})</h1>
                <hr />
